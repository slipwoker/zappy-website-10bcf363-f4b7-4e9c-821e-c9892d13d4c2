    ...
    if (contactForm) {
      ...
      function validateField(input) {
        ...
        if (input.hasAttribute('required') && value === '') {
          var label = input.getAttribute('placeholder') || name || 'This field';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '10bcf363-f4b7-4e9c-821e-c9892d13d4c2',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '10bcf363-f4b7-4e9c-821e-c9892d13d4c2';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '10bcf363-f4b7-4e9c-821e-c9892d13d4c2';
